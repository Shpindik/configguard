...
const (
	ScannerService_Scan_FullMethodName = "/configguard.v1.ScannerService/Scan"
)
...
//
// ScannerService проверяет конфигурацию на опасные настройки.
...
var ScannerService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "configguard.v1.ScannerService",
	...
	Metadata: "api/proto/configguard/v1/configguard.proto",
}
